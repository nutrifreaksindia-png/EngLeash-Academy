...
export default function DashboardPage({ users, pendingUsers, courses, batches, holidays, pendingApplications = [] }) {
  const stats = [
    ...
    { label: 'Pending Applications', value: pendingApplications.length },
    ...
    <div className="stack">
      ...
      <SectionCard title="What next?" subtitle="Recommended first setup steps">
        <ol className="todoList">
          <li>Add trainers and staff under <strong>Other Users → Directory</strong>, add students under <strong>Students</strong>, and process pending applications.</li>
